...
#ifndef __I2C_USI_EEPROM_H___
#define __I2C_USI_EEPROM_H___
 ...
 *
 * This has been modified to use the USI interface as used on some of the 
 * ATTiny devices
 *
 */
